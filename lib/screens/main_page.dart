...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
                ...
                children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                      children: [
                        Text('오늘은 ', style: TextStyle(color: Colors.white),),
                        TimerBuilder.periodic(Duration(minutes: 1), builder: (context){
                          return Text(getSystemTime(), style: TextStyle(color: Colors.white),);
                        }),
                        Text(' 입니다.', style: TextStyle(color: Colors.white),),
                      ],
                    ),
                    RichText(text: TextSpan(text: '오늘은 ',
                        style: TextStyle(color: Colors.white),
                    children: [
                      TextSpan(text: howBusy, style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                      TextSpan(text: '날 입니다.'),
                  ...
                  Container(height: height*.55, color: Colors.yellow,
    ...
    Container(color: Colors.black, height: height*.05,) // 광고
        ]
      )
    ])
    );
